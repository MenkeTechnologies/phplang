...
static PARAMS: &[(&str, Params)] = &[
    ...
    (
        ...
        &[
            (1, "array", "array"),
            (2, "length", "int"),
            (3, "preserve_keys", "bool"),
        ],
    ),
    ("array_column", &[(1, "array", "array")]),
    (
        "array_combine",
        &[(1, "keys", "array"), (2, "values", "array")],
    ),
    ...
    (
        "array_reverse",
        &[(1, "array", "array"), (2, "preserve_keys", "bool")],
    ),
    (
        "array_search",
    ...
    (
        "checkdate",
        &[(1, "month", "int"), (2, "day", "int"), (3, "year", "int")],
    ),
    (
        "chop",
        &[(1, "string", "string"), (2, "characters", "string")],
    ...
    (
        "class_exists",
        &[(1, "class", "string"), (2, "autoload", "bool")],
    ),
    ...
    (
        "filter_has_var",
        &[(1, "input_type", "int"), (2, "var_name", "string")],
    ),
    ("filter_var", &[(2, "filter", "int")]),
    (
        "filter_var_array",
        &[(1, "array", "array"), (3, "add_empty", "bool")],
    ),
    ...
    (
        "getenv",
        &[(1, "name", "?string"), (2, "local_only", "bool")],
    ),
    ("glob", &[(1, "pattern", "string"), (2, "flags", "int")]),
    (
        "gmdate",
        &[(1, "format", "string"), (2, "timestamp", "?int")],
    ),
    (
        "gmmktime",
        &[
    ...
    (
        "hash_equals",
        &[(1, "known_string", "string"), (2, "user_string", "string")],
    ),
    (
        "hash_file",
        &[
    ...
    (
        ...
        &[(1, "string", "string"), (2, "flags", "int")],
    ),
    (
        "http_build_query",
        &[
            (2, "numeric_prefix", "string"),
            (3, "arg_separator", "?string"),
            (4, "encoding_type", "int"),
        ],
    ),
    ...
    (
        ...
        &[
            (1, "string1", "string"),
            (2, "string2", "string"),
            (3, "insertion_cost", "int"),
            (4, "replacement_cost", "int"),
            (5, "deletion_cost", "int"),
        ],
    ),
    ...
    (
        "mb_chr",
        &[(1, "codepoint", "int"), (2, "encoding", "?string")],
    ),
    (
        "mb_convert_case",
        &[
    ...
    (
        "mb_convert_encoding",
        &[(1, "string", "array|string"), (2, "to_encoding", "string")],
    ),
    (
        "mb_convert_kana",
        &[
    ...
    (
        "metaphone",
        &[(1, "string", "string"), (2, "max_phonemes", "int")],
    ),
    ...
    (
        ...
        &[
            (1, "num", "int|float"),
            (2, "decimals", "int"),
            (3, "decimal_separator", "?string"),
            (4, "thousands_separator", "?string"),
        ],
    ),
    ...
    (
        "preg_quote",
        &[(1, "str", "string"), (2, "delimiter", "?string")],
    ),
    (
        "preg_replace",
        &[
    ...
    (
        "range",
        &[
            (1, "start", "string|int|float"),
            (2, "end", "string|int|float"),
            (3, "step", "int|float"),
        ],
    ),
    ...
    (
        "readfile",
        &[(1, "filename", "string"), (2, "use_include_path", "bool")],
    ),
    ...
    (
        "scandir",
        &[(1, "directory", "string"), (2, "sorting_order", "int")],
    ),
    ...
    (
        "sscanf",
        &[(1, "string", "string"), (2, "format", "string")],
    ),
    ...
    (
        "str_ireplace",
        &[
            (1, "search", "array|string"),
            (2, "replace", "array|string"),
            (3, "subject", "array|string"),
        ],
    ),
    (
    ...
    (
        "strtok",
        &[(1, "string", "string"), (2, "token", "?string")],
    ),
    ("strtolower", &[(1, "string", "string")]),
    (
        "strtotime",
        &[(1, "datetime", "string"), (2, "baseTimestamp", "?int")],
    ),
    ...
    (
        "tempnam",
        &[(1, "directory", "string"), (2, "prefix", "string")],
    ),
    (
        "time_nanosleep",
        &[(1, "seconds", "int"), (2, "nanoseconds", "int")],
    ),
    (
        "touch",
        &[
    ...
    (
        "trait_exists",
        &[(1, "trait", "string"), (2, "autoload", "bool")],
    ),
    (
        "trigger_error",
    ...
    (
        "vprintf",
        &[(1, "format", "string"), (2, "values", "array")],
    ),
    (
        "vsprintf",
        &[(1, "format", "string"), (2, "values", "array")],
